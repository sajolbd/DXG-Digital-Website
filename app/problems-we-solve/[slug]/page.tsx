          ...
          <div className="relative z-10 grid items-center gap-0 lg:min-h-[600px] lg:grid-cols-2">
            ...
            <div className="flex items-center px-4 py-8 sm:px-6 sm:py-10 lg:px-12 lg:py-20">
              <div className="max-w-2xl">
                <h1 className="text-3xl font-black uppercase leading-[0.95] text-white sm:text-4xl lg:text-6xl">
                  {service.title}
                </h1>
            ...
            {/* Mobile Image */}
            <div className="relative min-h-[200px] overflow-hidden lg:hidden sm:min-h-[250px]">
              <Image
                src={service.heroImage}
                alt={service.title}
                fill
